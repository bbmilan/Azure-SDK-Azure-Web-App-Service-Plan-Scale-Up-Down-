...
{
    public class Az_WebAppServicePlan_Scale_Down
    {

        [FunctionName("Az_WebAppServicePlan_Scale_Down")]
            ...
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)] HttpRequest req, ILogger log)
        {
            try
            {
                ...
                ArmOperation<AppServicePlanResource> operation = null; // Define the operation variable
                ...
                switch (appServicePlanData.Sku.Name)
                {
                    case "B2":
                        ...
                        appServicePlanData.Sku.Name = "B1";
                        appServicePlanData.Sku.Tier = "Basic";
                        appServicePlanData.Sku.Size = "B1";
                    ...
                    case "P1v3":
                        ...
                        // Update the service plan
                        operation = await appServicePlans.CreateOrUpdateAsync(Azure.WaitUntil.Completed, appServicePlanName, appServicePlanData);
                        Console.WriteLine($"App Service Plan has been scaled down to: {appServicePlanData.Sku.Name}");
                        break;
                    case "P1mv3":
                        // Assign new SKU details
                        appServicePlanData.Sku.Name = "P1v3";
                        appServicePlanData.Sku.Tier = "PremiumV3";
                        appServicePlanData.Sku.Size = "P1v3";
                        appServicePlanData.Sku.Family = "Pv3";
                        appServicePlanData.Sku.Capacity = 1;
                        // Update the service plan
                        operation = await appServicePlans.CreateOrUpdateAsync(Azure.WaitUntil.Completed, appServicePlanName, appServicePlanData);
